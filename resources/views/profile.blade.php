            ...
            <div class="col-sm-12 col-xs-12 col-md-8 col-lg-8 col-md-mt-3">
                <div class="p_info">
                    ...
                    <div class="mt-5">
                        ...
                        <hr>
                        <a type="submit" class="btn btn-default login-btn" href="/edit">Change Password</a>
                    </div>
                ...
                <div class="p-info d-none">
                    ...
                    <hr>
                    <a type="submit" class="btn btn-default login-btn" href="/edit">Edit profile</a>
                </div>
