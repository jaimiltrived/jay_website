    ...
    <div class="container" style="padding-top: 7%;">
        <div class="card shadow" style="border-radius: 12px;">
            <div class="card-header bg-dark text-white">
                <h4 class="mb-0">Add New Home Section</h4>
            </div>
            <div class="card-body bg-light">
                <form action="{{ route('add_new_home_content') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="sectionTitle" name="section_title" 
                                value="{{ old('section_title') }}" placeholder="Enter section title">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="hotelName" name="hotel_name" 
                                value="{{ old('hotel_name') }}" placeholder="Enter hotel name">
