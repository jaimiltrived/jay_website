                ...
                <form action="{{ route('update_room' , $room->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="roomTitle" name="name" value="{{ $room->product_name }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="personCapacity" name="capacity"
                                value="{{ $room->capacity}}" placeholder="Enter person capacity">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="roomPrice" name="price" value="{{ $room->new_price }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select" id="roomStatus" name="status">
                                <option value="Available" {{ $room->occupancy_status  == 'available' ? 'selected' : '' }}>Available
                                </option>
                                <option value="Occupied" {{$room->occupancy_status  == 'booked' ? 'selected' : '' }}>Occupied</option>
                                <option value="Maintenance" {{ $room->occupancy_status  == 'maintenance' ? 'selected' : '' }}>Maintenance
                                </option>
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="roomDescription" name="description" rows="3"
                                placeholder="Enter room description">{{ $room->discription  }}</textarea>
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-success px-4">update Room</button>
                        </div>
                    </div>
                </form>
