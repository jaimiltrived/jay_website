    ...
    <div class="container" style="padding-top: 7%;">
        <div class="card shadow" style="border-radius: 12px;">
            ...
            <div class="card-body bg-light">
                <form action="{{ route('edit_blog', $blog->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">

                        <div class="col-md-12">
                            <label for="Blogslug" class="form-label fw-bold">Blog Slug</label>
                            <input type="text" class="form-control" id="Blogslug" name="slug" value="{{ $blog->slug }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="personCapacity" name="name"
                                value="{{ $blog->name }}" placeholder="Enter blog name">
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-success px-4">Edit Room</button>
                        </div>
                    </div>
                </form>
